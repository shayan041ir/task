    ...
    <div class="page custom-index">
            ...
            <div class="main-container container-fluid">
                ...
                <div class="main-content-body">
                    ...
                    <div class="d-flex justify-content-between align-items-center mb-4">
                        ...
                        <button class="btn btn-success" id="addUserBtn"><i class="fas fa-plus"></i> افزودن کاربر
                            جدید</button>
                    </div>
                            ...
                            <table id="usersTable" class="table table-striped table-hover table-bordered"
                                ...
                                <thead class="table-dark">
                                    <tr>
                                        ...
                                        <th class="text-center" style="width: 20%;">تاریخ تولد</th>
                            ...
                            <div class="modal-content">
                                <form id="userForm">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <div class="mb-3">
                                            <label for="userBirthDate" class="form-label">تاریخ تولد</label>
                                        ...
                                        <div class="mb-3">
                                            <label for="userPassword" class="form-label">رمز عبور (در صورت
                                                تغییر)</label>
                    ...
                    <?php if (isset($mode) && $mode === 'edit' && isset($user)): ?>
                        <div class="card shadow-sm mt-4">
                            ...
                            <div class="card-body">
                                ...
                                <div class="mb-3">
                                    <label for="editBirthDate" class="form-label">تاریخ تولد</label>
                                    <input class="form-control" type="date" name="birth_date" id="editBirthDate" 
                                ...
                                <div class="mb-3">
                                    ...
                                    <select name="role" class="form-control" id="editRole">
                                        <option value="user" <?= ($user->role === 'user') ? 'selected' : '' ?>>کاربر عادی
                                        </option>
                                ...
                                <?= form_close(); ?>
                                <p class="mt-3"><a href="<?= site_url('admin/users'); ?>" class="btn btn-link">بازگشت به
                                        لیست</a></p>
                            </div>
                        </div>
                    <?php endif; ?>
        ...
        <div class="main-footer ht-45 bg-dark text-white">
            <div class="container-fluid pd-t-0 ht-100p text-center">
                <span><a href="javascript:void(0);" class="text-white">ادمینِتو</a> - طراحی با عشق <span
                        class="fa fa-heart text-danger"></span> توسط تیم برنامه‌نویسان ادمینِتو</span>
            </div>
        </div>
        <!-- پایان فوتر -->
